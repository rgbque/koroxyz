...
Updates vary depending on the season:
...
Developers will appear here as the project grows.
...
##  Installation Guide
0. Make sure dark mode is enabled as the website theme in [Korone Settings](https://www.pekora.zip/My/Account).
